...
*/
 ...
 if (strpos(STORE_OWNER_EMAIL_ADDRESS, '<')) {
  ...
  define('MODULE_ADDONS_INCENTIBOX_DESCRIPTION', '<p>'. tep_image(DIR_WS_IMAGES . 'incentiBox_logo.png', 'incentiBox', '190','40','style="display:block;margin:0px auto;"') .'<br />The incentiBox Social Media Sharing Rewards module enables users to sign in to your CREloaded store via Facebook account, and incentivizes your customers and site-visitors to "like" your Facebook page, and share your products with their friends via social media (Facebook, Twitter, Tumblr, and 300+ others). In return, your customers receive store credit, redeemable only at your store! <br/><br /><strong>Special offer for CRE Loaded Merchants: <a target="_blank" href="'. INCENTIBOX_CRELOADED_LINK .'">Sign up today</a> for TWO months free service!</strong> <br />Please see <a target="_blank" href="'. INCENTIBOX_CRELOADED_LINK .'">incentiBox</a> for more details and to create your account.</p>');
?>